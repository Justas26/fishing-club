            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('member.store')}}">
                        ...
                        <div class="form-group">
                            <label>Live</label>
                            <input type="text" name="live" class="form-control" value="{{old('live')}}">
                            <small class="form-text text-muted">Member live.</small>
                        </div>
                        <div class="form-group">
                            <label>Expierence</label>
                            <input type="text" name="expierence" class="form-control" value="{{old('expierence')}}">
                            <small class="form-text text-muted">Member expierence.</small>
                        </div>
                        <div class="form-group">
                            <label>Registered</label>
                            <input type="text" name="registered" class="form-control" value="{{old('registered')}}">
