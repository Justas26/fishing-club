...
Route::group(['prefix' => 'members'], function () {
    ...
    Route::post('uploadPhoto/{member}', [MemberController::class, 'uploadPhoto'])->name('member.uploadPhoto');
});
...
Route::group(['prefix' => 'reservoirs'], function () {
    ...
    Route::post('uploadPhoto/{reservoir}', [ReservoirController::class, 'uploadPhoto'])->name('reservoir.uploadPhoto');
});
